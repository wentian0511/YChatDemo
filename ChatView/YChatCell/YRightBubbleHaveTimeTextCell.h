//
//  YRightBubbleHaveTimeTextCell.h
//  YChatDemo
//
...
@class YRightBubbleHaveTimeTextCell;

@protocol YRightBubbleHaveTimeTextCellDelegate <NSObject>

- (void)yRBHTWhetherAgainSendMessage:(YRightBubbleHaveTimeTextCell *)yRightBubbleHaveTimeTextCell;

@end

@interface YRightBubbleHaveTimeTextCell : UITableViewCell

@property (nonatomic, assign) id<YRightBubbleHaveTimeTextCellDelegate>yDelegate;
